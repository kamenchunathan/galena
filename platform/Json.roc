## This is the Luke's Json encoder to be used as a temporary encoder / decoder for
## now before I write a more efficient byte decoder
## https://github.com/lukewilliamboswell/roc-json/blob/main/package/Json.roc
module [
    Json,
    utf8,
    utf8_with,

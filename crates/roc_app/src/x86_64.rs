...
impl InternalAttr {
    ...
    pub fn discriminant(&self) -> discriminant_InternalAttr {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_InternalAttr>(*bytes.as_ptr().add(48))
        }
    }
...
const _SIZE_CHECK_InternalHtml: () = assert!(core::mem::size_of::<InternalHtml>() == 8);
const _ALIGN_CHECK_InternalHtml: () = assert!(core::mem::align_of::<InternalHtml>() == 8);
